...
| ------------------ | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| id                 | string | REQUIRED | Unique action id.                                                                                                                            |
| input.provider     | string | REQUIRED | Id of the repository dependency that fronts the AI provider — a `remote` repository (module-authored endpoint + auth interceptor) or an `ai` repository (host-injected provider, §5.3).                                        |
